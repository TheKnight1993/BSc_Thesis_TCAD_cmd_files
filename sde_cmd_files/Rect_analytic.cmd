...
; Define and set constant doping profiles
...
(sdedr:define-refeval-window "BaseLine.DNW" "Rectangle"
	(position -7 -9.8 -9.8)
	(position -7 9.8 9.8))
(sdedr:define-refeval-window "BaseLine.NW" "Polygon" (list 
	(position -10 -10.8 -10.8)
	(position -10 -10.8 10.8)
	(position -10 10.8 10.8)
	(position -10 10.8 -10.8)
	(position -10 -9.2 -10.8)
	(position -10 -9.2 -9.2)
	(position -10 9.2 -9.2)
	(position -10 9.2 9.2)
	(position -10 -9.2 9.2)
	(position -10 -9.21 -10.8)))
(sdedr:define-refeval-window "BaseLine.NP" "Polygon" (list
	(position -10 -11.8 -11.8)
	(position -10 -11.8 11.8)
	(position -10 11.8 11.8)
	(position -10 11.8 -11.8)
	(position -10 -8.2 -11.8)
	(position -10 -8.2 -8.2)
	(position -10 8.2 -8.2)
	(position -10 8.2 8.2)
	(position -10 -8.2 8.2)
	(position -10 -8.21 -11.8)))
(sdedr:define-refeval-window "BaseLine.PP" "Rectangle"
	(position -10 -6.8 -6.8)
	(position -10 6.8 6.8))
...
(sdedr:define-gaussian-profile "Gauss.DNW"
	...
	"ValueAtDepth" 3e14 "Depth" 2.5 "Gauss" "Factor" 0.5)
(sdedr:define-gaussian-profile "Gauss.NW"
...
(sdedr:define-analytical-profile-placement "PlaceAP.DNW"
	"Gauss.DNW" "BaseLine.DNW" "Positive" "NoReplace" "Eval")
(sdedr:define-analytical-profile-placement "PlaceAP.NW"
	"Gauss.NW" "BaseLine.NW" "Negative" "NoReplace" "Eval")
(sdedr:define-analytical-profile-placement "PlaceAP.NP"
	"Gauss.NP" "BaseLine.NP" "Negative" "NoReplace" "Eval")
